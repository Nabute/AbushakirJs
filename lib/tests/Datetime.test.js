...
describe('Testing Helper Methods `sixDigits`', function () {
    it('should return a six-digit string for a positive number', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['sixDigits'](300); // Accessing a private method for testing
        expect(result).toBe('+0300');
    });
    it('should return a six-digit string for a negative number', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['sixDigits'](-300);
        expect(result).toBe('-0300');
    });
    it('should throw an error for a number outside the valid range', function () {
        var etDatetime = new datetime_1.default();
        expect(function () { return etDatetime['sixDigits'](1000000); }).toThrowError('Year out of scope');
    });
});
describe('Testing Helper Methods `fourDigits`', function () {
    it('should return a four-digit string for positive numbers', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['fourDigits'](1234);
        expect(result).toBe('1234');
    });
    it('should return a four-digit string for negative numbers', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['fourDigits'](-5678);
        expect(result).toBe('-5678');
    });
    it('should pad with zeros for numbers less than 1000', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['fourDigits'](78);
        expect(result).toBe('0078');
    });
    it('should return the input for zero', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['fourDigits'](0);
        expect(result).toBe('0000');
    });
});
describe('Testing Helper Methods `threeDigits`', function () {
    it('should return a string with three digits for numbers greater than or equal to 100', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['threeDigits'](150);
        expect(result).toBe('150');
    });
    it('should return a string with two digits and a leading zero for numbers between 10 and 99', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['threeDigits'](42);
        expect(result).toBe('042');
    });
    it('should return a string with three digits and leading zeros for numbers between 0 and 9', function () {
        var etDatetime = new datetime_1.default();
        var result = etDatetime['threeDigits'](7);
        expect(result).toBe('007');
    });
});
describe('Testing Helper Methods `toNumber`', function () {
    ...
    it('should throw an error for symbol input', function () {
        var etDatetime = new datetime_1.default();
        expect(function () { return etDatetime["toNumber"](Symbol()); }).toThrowError('TYPE ERROR: Unexpected operand type.');
    });
    it('should throw an error for object input', function () {
        var etDatetime = new datetime_1.default();
        expect(function () { return etDatetime["toNumber"]({}); }).toThrowError('TYPE ERROR: Unexpected operand type.');
    });
});
